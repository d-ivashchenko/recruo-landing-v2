        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-muted-foreground max-w-xs">
              Enhancing technical hiring with AI-powered screening and interviews.
            </p>
            <div className="mt-6 flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/recruo/" className="text-muted-foreground hover:text-accent">
                <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="https://app.recruo.com/privacy-policy" className="text-muted-foreground hover:text-accent">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="https://app.recruo.com/term-of-use" className="text-muted-foreground hover:text-accent">
                  Terms of Service
                </Link>
              </li>
              <li>
